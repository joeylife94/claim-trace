...
This dedicated integration acceptance harness is excluded from ordinary pytest
recursion and invoked explicitly by the D3 workflow. It reuses the existing
PostgreSQL integration fixtures without adding an environment-dependent skip to
normal closure suites.
"""
